...
@registry.register("devops", AgentCapabilities(description="Handles deployment and infrastructure.", tools=["deploy"], agent_level="TASK_DOER"))
def devops_agent(task_data: InputData) -> AgentResponse:
    ...
    sys_prompt = f"You are the devops agent. Your job is to fulfill the user's request expertly."
